...
- **📸 AI 생성 이미지 진위 여부 탐지 파이프라인 (Fake Image Detector)**:
  - Google/SynthID 기술을 흉내내어 만들어본 실생활 이미지와 AI 생성물 비교 실험을 통해 도출된 **최적의 주파수 임계치**를 바탕으로 최신 딥러닝 **Transformer 앙상블** 모델을 결합하여, Midjourney, FLUX 등 초고화질 AI 생성 이미지를 높은 정밀도로 식별합니다.
...
- **데모 영상 (MP4)**: <br><video src="2026_03_20%2003_51.mp4" width="100%" controls></video>
